                    ...
                    >
                        <div className="relative z-10 max-w-3xl">
                            <h3 className="text-xl md:text-2xl font-bold font-grotesk mb-8 text-white tracking-tight leading-relaxed">
                                I am a <span className="text-secondary font-extrabold">Full Stack AI Developer</span> dedicated to engineering high-performance, scalable systems that bridge the gap between complex AI models and intuitive user experiences.
                            </h3>
                            <p className="text-slate-400 text-base md:text-lg leading-relaxed font-inter font-light tracking-wide italic border-l-2 border-primary/20 pl-6 py-2">
                                My expertise lies in designing modern web architectures and intelligent backend systems. From pixel-perfect interfaces to low-latency neural integrations, I focus on technical excellence and purposeful code to build digital products that matter.
                            </p>
                        </div>
